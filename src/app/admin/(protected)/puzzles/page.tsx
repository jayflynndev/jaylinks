...
/** The Daily puzzle library: full list plus schedule-gap warnings. Moved here from the Dashboard (now a stats overview at /admin) so "browse/manage puzzles" and "how's the game doing" are separate pages. */
